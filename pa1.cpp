...
double computeArea(Point &a, Point &b, Point &c)
{
    ...
    lengthA = c.distanceTo(b);  //member function that calculates distance from Point C to Point B
                                //inserts return value of distance into length of a

    lengthB = a.distanceTo(c);  //member function that calculates distance from Point A to Point C
                                //inserts return value of distance into length of b

    lengthC = a.distanceTo(b);  //member function that calculates distance from Point A to Point B
                                //inserts return value of distance into length of c
